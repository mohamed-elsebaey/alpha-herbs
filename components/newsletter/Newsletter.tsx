...
function Newsletter() {
  return (
    // Forms Section Start
    <section className="relative z-10 bg-white my-10 ">
            ...
            <div className="w-full self-center px-4 lg:w-1/2">
              <div className="relative z-10 px-6 py-9 sm:p-10">
                ...
                <form className="flex flex-wrap pb-1">
                  <input
                    type="email"
                    className="mb-3 mr-3 h-[50px] w-full max-w-[220px] rounded-md border  bg-white px-5 text-sm text-body-color outline-none focus:border-primary md:max-w-[315px] lg:max-w-[250px] xl:max-w-[315px]   "
